...
public class Compress {
    ...
    public static void compress(String path) {
        ...
        if (seqNumber > 1) {
            File lngcFile = new File(path + ".lngc");
            if (lngcFile.exists()) lngcFile.delete();
            File descFile = new File(path + ".desc");
            ...
            try {
                codeMatch(tmpDirectoryPath, 4);

                File file;
                String info;
                bw1 = new BufferedWriter(new FileWriter(lngcFile, true));
